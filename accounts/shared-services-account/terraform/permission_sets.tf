...
resource "aws_ssoadmin_permission_set" "admin" {
  ...
  name             = "${permission_sets_prefix}AdministratorAccess"
...
resource "aws_ssoadmin_permission_set" "billing" {
  instance_arn     = tolist(data.aws_ssoadmin_instances.this.arns)[0]
  name             = "${permission_sets_prefix}Billing"
...
resource "aws_ssoadmin_permission_set" "power_user" {
  instance_arn     = tolist(data.aws_ssoadmin_instances.this.arns)[0]
  name             = "${permission_sets_prefix}PowerUserAccess"
...
resource "aws_ssoadmin_permission_set" "network_administrator" {
  instance_arn     = tolist(data.aws_ssoadmin_instances.this.arns)[0]
  name             = "${permission_sets_prefix}NetworkAdministrator"
...
resource "aws_ssoadmin_permission_set" "database_admin" {
  instance_arn     = tolist(data.aws_ssoadmin_instances.this.arns)[0]
  name             = "${permission_sets_prefix}DatabaseAdministrator"
...
resource "aws_ssoadmin_permission_set" "security_audit" {
  instance_arn     = tolist(data.aws_ssoadmin_instances.this.arns)[0]
  name             = "${permission_sets_prefix}SecurityAudit"
...
resource "aws_ssoadmin_permission_set" "support_access" {
  instance_arn     = tolist(data.aws_ssoadmin_instances.this.arns)[0]
  name             = "${permission_sets_prefix}SupportAccess"
...
resource "aws_ssoadmin_permission_set" "system_admin" {
  instance_arn     = tolist(data.aws_ssoadmin_instances.this.arns)[0]
  name             = "${permission_sets_prefix}SystemAdministrator"
...
resource "aws_ssoadmin_permission_set" "read_only" {
  instance_arn     = tolist(data.aws_ssoadmin_instances.this.arns)[0]
  name             = "${permission_sets_prefix}ReadOnlyAccess"
